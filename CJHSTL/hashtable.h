...
//	cout << endl;
//
//	CJH::hashtable<int, int> table;
//	cout << "table.size() =" << table.size() << endl;
//	cout << "table.bucket_count() =" << table.bucket_count() << endl;
//	cout << "table.size() =" << table.max_bucket_count() << endl;
...
//	CJH::hashtable<int, int>::iterator it = table.begin();
//	CJH::copy(table.begin(), table.end(), ostream_iterator<int>(cout, " "));
//	cout << endl;
//
//
...
//	}
//	it = table.begin();
//	for (size_t i = 0; i < table.size(); ++i, ++it){
//		cout << *it << " ";
//	}
//	cout << endl;
//	cout << *(table.find(2)) << endl;
//	cout << table.count(2);
//	return 0;
//}
