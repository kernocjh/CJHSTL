...
//	//v.push_back(1);
//	A a;
//	CJH::rbtree_base<int, A> rb;
//
//	for (int i = 0; i < 100; ++i){
//		rb.insert_equal(CJH::pair<int, A>(8, a));
//
//	}
//	/*for (int i = 0; i < 100; ++i){
//	if (i == 98)
//	i = i;
//	rb.erase(rb.begin()._GetNode_Cur()->key);
//
//	}
//
//	rb.clear();
//	int i = 0;
//	for (CJH::rbtree_base<int, A>::iterator it1 = rb.begin(); it1 != rb.end(); ++it1)
//	cout << ++i << endl;*/
//	CJH::rbtree_base<int, A> rb0;
//	rb0 = rb;
//	rb0 = rb;
//	CJH::rbtree_base<int, A>::iterator it = rb0.begin();
//	CJH::rbtree_base<int, A>::iterator it1 = rb.begin();
//	for (; it1 != rb.end(); ++it1, ++it){
//		//	cout << *it << "  " << *it1 << endl;
//	}
//	rb0.travelor();
//	return 0;
...
//	//v.pop_back();
//	//v.push_back(1);
//	CJH::rbtree_base<int, int> rb;
//	for (int i = 0; i < 1000; ++i){
//		rb.insert_equal(CJH::pair<int, int>(1, i + 1));
//	}
//
//	CJH::rbtree_base<int, int>::iterator it = rb.end();
//	--it;
//	for (; it != rb.begin(); --it){
//		cout << *it << " \n";
//	}
